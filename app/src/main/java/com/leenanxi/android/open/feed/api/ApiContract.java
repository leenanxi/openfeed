...
public interface ApiContract {
    //make sure all cache keys if unique and match regex [a-z0-9_-]{1,64}
    interface CacheKeys {
        String BROADCAST_LIST = "broadcast_list";
    ...
    interface Request {
        ...
        @com.leenanxi.android.open.feed.api.Frodo
        interface Frodo {
            String API_KEY = Request.API_KEY;
            String API_SECRET = "9e8bb54dc3288cdf";
