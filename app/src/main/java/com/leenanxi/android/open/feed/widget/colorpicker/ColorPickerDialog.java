...
package com.leenanxi.android.open.feed.widget.colorpicker;
...
import com.leenanxi.android.open.feed.widget.colorpicker.ColorPickerSwatch.OnColorSelectedListener;
...
public class ColorPickerDialog extends DialogFragment implements OnColorSelectedListener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(getActivity()).inflate(R.layout.widget_color_picker_dialog, null);
