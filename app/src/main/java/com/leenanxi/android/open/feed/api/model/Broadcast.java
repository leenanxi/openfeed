...
public class Broadcast implements Parcelable {
    public static final Creator<Broadcast> CREATOR =
            new Creator<Broadcast>() {
    ...
    /**
     * Use {@link com.leenanxi.android.open.feed.widget.TimeActionTextView} instead if the text is to be set
     * on a {@code TextView}.
     */
